...
class ZohoEmailProcessor:
    ...
    def create_standard_reply(self, original_email):
        ...
        # You can customize this reply template
        reply_template = """
...
if __name__ == "__main__":
    ...
    # Option 2: Run continuously (check every 60 seconds)
    processor.run_continuous(check_interval=60)
    
    # Option 3: Custom check interval (e.g., every 5 minutes)
    # processor.run_continuous(check_interval=300)